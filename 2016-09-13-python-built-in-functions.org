...
---
layout: post
title: Python built-in functions dissection
tagline: " by TDD"
...
** Test runner
   ...
   ======================================================================
   FAIL: test_simple_behaviour (tests.test_built-in_functions.TestSuper)
   ----------------------------------------------------------------------
   Traceback (most recent call last):
     File "/usr/local/share/DVCS/org-pub/tests/test_built-in_functions.py", line 1042, in test_simple_behaviour
       "It is a parent class' method")
   AssertionError: False is not true

   ----------------------------------------------------------------------
   Ran 169 tests in 0.065s
