...
** Test runner
   ...
   test_bool_argument (tests.test_built-in_functions.TestAll) ... ok
   test_non_iter_argument (tests.test_built-in_functions.TestAll) ... ok
   ...
   test_string_as_argument (tests.test_built-in_functions.TestAll) ... ok
