...
* Preface
  ...
  current state of things related to programming, obvious deductions
  and the straightforward approach to eradicate this phenomena once
  and forever.
...
* A dumb testing set (test the test itself)                        :noexport:
   ...
   #+BEGIN_SRC python :noweb yes :tangle tests/test_00dumb_testing.py :exports none
     """
