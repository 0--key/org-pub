...
* Preface
  ...
  reader a =kingdom of programming=. There is only one path: a bit
  straightforward, but narrow approach to get rid the *misleading
  phenomenon* off once and forever in professional and personal life.
  Yes it is neither simple nor popular, alas. It's a primal learning,
  boys and girls.
...
* Style Notes
  ...
  be fun at the reading, to alleviate the headache and brain fog
  /studying programming by excluding cramming/. A multiplied
  repetition with hope to rehearse the chunk of studied material and
  forget it forever — fast and malicious way to achieve knowledge. It
  is a redundant, tedious and popular way to do things wrong. All what
  you're need in is to delve into Python depths leading by an
  experience guide. That's it.

  All articles are short enough to being grasped _less than 25
  minutes_. The average pace is /going forward only after the current
  point is trivial for you personally/. No need to restrict yourself
  to read down and down without any comprehension. Slow your pace,
  please. Couldn't check it up. Or, maybe this book is not for you.
