...
* Style Notes
  ...
  another user manual, journal or notes with comments abundance.
  ...
  forget it forever — short, attractive but lousy way to achieve
  knowledge. It is a _cognition lure._ It is a redundant, tedious and,
  in same time, _popular way to do things wrong._ All what you are
  need in is to delve into Python depths leading by an experience
  guide. That's it.
