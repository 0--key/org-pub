...
** Machine Code vs Source Code vs Program
   ...
   It is a /code/ by definition and it is a /source/ of /machine code/
   before compilation. These peculiar niceties allow to write programs
   as a /code/, neglecting the most significant feature of high-level
   programming language - its *readability*, and name this
   /pseudo-program/ as a /source code/. Yes, it is wierd, and in some
   cases it is convenient: it allows you type less, comment nothing,
