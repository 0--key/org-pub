...
**** Wrong approach in studying
     ...
     macnihens is a relatevely fossil lore for humans. I suppose that
     1940s was an early begining. It was a straightforward coding due
     to absence of high-level programming languages.
     ...
     The new and modern human-readable hight-level programming
     languages galore was announced in 1970s due to widely spreaded
     idea to write programs as a human-friendly text and compile it
     later into the source code (mostly unreadable by humans)
     executable by machines at least.
     
**** The main intention of this book is
     to bridge the gap between human cognition and...

**** By intention is is a vastly oversimplified approach,
     but the game worths candles - it is a gentle, narrow and holistic
     attempt to shade the light on this taught subject as computation
     is.
